...
| `destinations [-t <name>]` | data_destinations (self-registered on settings apply, §6b; bare = the destination table with its live counters/backoff/last error, `-t` = deliver one destination now and print the outcome) |
